...
FinRunbook pins third-party projects as Git submodules and does not copy their
contents into its own source tree. The source, copyright notices, and complete
license text for each dependency are available at the path below.

| Project | Upstream | Local license |
| --- | --- | --- |
| Anthropic Financial Services | https://github.com/anthropics/financial-services | `vendor/anthropic-financial-services/LICENSE` (Apache-2.0) |
